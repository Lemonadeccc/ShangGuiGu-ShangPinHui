    ...
    <div class="order-content">
      ...
      <div class="choose-order">
        ...
        <!-- 分页器:测试分页器阶段，这里的数据将来需要替换的。  -->
          <Pagination :pageNo="page" :pageSize="limit" 
          total="myOrder.total" continues="5" @getPageNo="getPageNo"/>
...
export default {
  ...
  methods: {
    ...
    async getData(){
        //解构出参数
        const {pages,limit} = this;
        let result = await this.$API.reqMyOrderList(pages,limit);
        if(result.code == 200){
