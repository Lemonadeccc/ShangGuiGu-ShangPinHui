<template>
  <div class="detail">
    ...
    <section class="con">
      <!-- 导航路径区域 -->
      <div class="conPoin">
        <span v-show="categoryView.category1Name">{{category.category1Name}}</span>
        <span v-show="categoryView.category2Name">{{category.category2Name}}</span>
        <span v-show="categoryView.category3Name">{{category.category3Name}}</span>
      </div>
      <!-- 主要内容区域 -->
      <div class="mainCon">
        <!-- 左侧放大镜区域 -->
